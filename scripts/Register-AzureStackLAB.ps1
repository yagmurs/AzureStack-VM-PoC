...
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/Azure/AzureStack-Tools/master/Registration/RegisterWithAzure.psm1" -OutFile "C:\AzureStackonAzureVMRegisterWithAzure.psm1" 
